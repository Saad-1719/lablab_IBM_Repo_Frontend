    ...
    <header className="sticky top-0 z-50 w-full bg-white border-b border-border shadow-sm">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold text-primary hidden sm:inline">Agent Hub</span>
        </div>
        ...
        >
          <a href="#agents" className="text-foreground hover:text-primary transition font-medium">
            Agents
          </a>
          <a href="#chat" className="text-foreground hover:text-primary transition font-medium">
            Chat
          </a>
        </div>
      </nav>
